...
import { X, FileText, Download, Send, CheckCircle2, Phone, Sparkles, Eye, Mail } from 'lucide-react';
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            <button
                              ...
                              className="px-2.5 py-1.5 bg-[#FAF8F5] hover:bg-[#0B1D30] hover:text-white text-[#0B1D30] border border-[#E7E2D8] text-[11px] font-semibold rounded-lg transition-colors flex items-center gap-1"
                              title="View document"
                            >
                              <Eye className="w-3 h-3 text-[#D97745]" />
                              <span>View</span>
                            </button>
                            <a
                              href={item.file}
                              download
                              className="px-3 py-1.5 bg-[#D97745] hover:bg-[#C8652D] text-white text-[11px] font-bold rounded-lg transition-colors flex items-center gap-1"
                  ...
                  <div>
                    {formSubmitted ? (
                      <div className="py-12 text-center space-y-4">
                        ...
                        <h4 className="font-cinzel font-bold text-xl text-[#0B1D30]">Enquiry Ready!</h4>
                        <p className="text-xs text-[#4A5568] max-w-xs mx-auto">
                          We have redirected you to your email client addressed to <code className="text-[#D97745]">cvtarapur@chinmayamission.com</code>.
                        </p>
                        {submittedMailto && (
                          <div className="pt-2">
                            <a
                              href={submittedMailto}
                              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0B1D30] hover:bg-[#D97745] text-white text-xs font-bold rounded-xl transition-colors shadow-sm"
                            >
                        ...
                        <button
                          ...
                          className="text-xs text-slate-500 hover:text-[#0B1D30] underline block mx-auto pt-4"
                        >
                    ...
                    {[
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-xs text-[#D97745] hover:underline font-semibold flex items-center gap-1"
                        >
